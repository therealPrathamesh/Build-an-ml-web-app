    ...
    if request.method == 'POST':
        ...
        try:
            if request.form['state'] in NON_DISCLOSURE_STATES:
              flash('You are asking for a prediction in a nonn-disclosure state. We do not have data on transactions for such states so please take our predictions with a grain of salt.' )
